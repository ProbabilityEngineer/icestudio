     ...
     */
      ...
      class FormBasicCode extends Form {
        ...
        constructor(
          ...
          this.addField(field0, 'Module Ports');
          this.addField(field1, 'Module Ports');
          this.addField(field2, 'Module Ports');
          let field3 = false;
          let field4 = false;
          ...
          if (allowInoutPorts) {
            ...
            //-- Add the field to the form
            this.addField(field3, 'Module Ports');
            ...
            //-- Add the field to the form
            this.addField(field4, 'Module Ports');
          }
          this.code = '';
          let self = this;
          //-- Field 5: Import code
